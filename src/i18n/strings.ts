...
const es: UIStrings = {
  ...
  intro: {
    ...
    subtitle: '10 decisiones rápidas. No hay respuestas correctas. Seguí tu instinto.',
  ...
  round: {
    ...
    dragHint: 'Arrastrá el control para definir tu división',
    lockIn: 'Confirmar',
    drawing: 'Sorteando… — tocá para acelerar',
    nextRound: 'Siguiente ronda',
    seeProfile: 'Ver mi perfil',
    chooseFirst: 'Primero elegí tu división',
    ...
    noSplitAria: 'Aún no elegiste una división — arrastrá para definir tu asignación',
  ...
  coach: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: 'Esta barra muestra cada resultado de tu división — más ancho = más probable, verde = ganancia, rojo = pérdida.',
      },
      {
        title: 'Definí tu división',
        body: 'Arrastrá para repartir tus $10,000. La barra se actualiza en vivo.',
      },
      {
        title: 'Confirmalo',
  ...
  result: {
    ...
    tentative: 'Preliminar — la mejor aproximación.',
  ...
  dashboard: {
    ...
    localNone: 'Aún no hay cartera modelo local para este arquetipo.',
  },
  instrumentDetail: {
