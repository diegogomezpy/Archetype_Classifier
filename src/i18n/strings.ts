...
const en = {
  ...
  dashboard: {
    ...
    portfolioLocal: 'Local portfolio (Cadiem)',
  ...
  admin: {
    ...
    region: 'Market',
    assetClass: 'Category',
    loadCadiem: (n: number) => `Load Cadiem local menu (${n})`,
  ...
  adminArch: {
    ...
    localMixTitle: 'Local model mix (Cadiem)',
    localMixHint:
      'The local model portfolio across the Cadiem categories, shown alongside the global one. Percentages are normalized to 100 on save.',
    total: 'Total',
...
const es: UIStrings = {
  ...
  dashboard: {
    ...
    portfolioLocal: 'Portafolio local (Cadiem)',
  ...
  admin: {
    ...
    loadCadiem: (n: number) => `Cargar menú local Cadiem (${n})`,
  ...
  adminArch: {
    ...
    localMixTitle: 'Mezcla modelo local (Cadiem)',
    localMixHint:
      'El portafolio modelo local sobre las categorías Cadiem, mostrado junto al global. Los porcentajes se normalizan a 100 al guardar.',
    total: 'Total',
