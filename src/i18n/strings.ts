...
const en = {
  ...
  admin: {
    ...
    autofillHint: 'Enter a ticker or ISIN to auto-fill the details below.',
    autofillFilled: 'Details filled from market data.',
    autofillNeedId: 'Enter a ticker or ISIN first.',
    autofillUnavailable: 'Automatic fetch needs the market-data backend (coming with Phase 2). Enter details manually for now.',
...
const es: UIStrings = {
  ...
  admin: {
    ...
    autofillHint: 'Ingresa un ticker o ISIN para autocompletar los detalles.',
    autofillFilled: 'Detalles completados desde datos de mercado.',
    autofillNeedId: 'Ingresa primero un ticker o ISIN.',
    autofillUnavailable: 'La obtención automática requiere el backend de datos de mercado (llega con la Fase 2). Por ahora, ingresa los detalles manualmente.',
