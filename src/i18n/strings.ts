...
const en = {
  ...
  portfolioPanel: {
    ...
    assetCount: 'Assets',
    assetCountHint: 'How many instruments the suggested book holds in total — split across classes by the band’s mix.',
    more: 'One more instrument',
    fewer: 'One fewer instrument',
  ...
  adminScreener: {
    title: 'Screener',
    subtitle:
      'Narrow any asset class by its own traits — price-target upside, yield, duration, credit, barrier — then publish that subset. Advisors only ever see the instruments selected here for that class.',
    filters: 'Filters',
    clear: 'Clear',
...
const es: UIStrings = {
  ...
  portfolioPanel: {
    ...
    assetCount: 'Activos',
    assetCountHint: 'Cuántos instrumentos tiene la cartera sugerida en total — se reparten entre clases según la mezcla de la banda.',
    more: 'Un instrumento más',
    fewer: 'Un instrumento menos',
  ...
  adminScreener: {
    ...
    subtitle:
      'Filtrá cualquier clase de activo por sus propios atributos — potencial vs. precio objetivo, rendimiento, duración, crédito, barrera — y publicá ese subconjunto. Los asesores solo ven los instrumentos seleccionados acá para esa clase.',
    filters: 'Filtros',
    clear: 'Limpiar',
